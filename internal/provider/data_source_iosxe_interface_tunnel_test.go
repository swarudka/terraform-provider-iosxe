...
func TestAccDataSourceIosxeInterfaceTunnel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "vrf_forwarding", "VRF1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ipv6_nd_ra_suppress_all", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ipv6_address_dhcp", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ip_mtu", "1400"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ipv6_link_local_addresses.0.address", "fe80::9656:d028:8652:66ba"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ip_access_group_in", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ip_access_group_in_enable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ip_access_group_out", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ip_access_group_out_enable", "true"))
